...
<html lang="en">
  <head>
      ...
      <title>Create Server - Pteranodon</title>
  ...
  <body>
      ...
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1">
          <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="manage-server.php" class="text-2xl block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Manage servers</a>
            </li>
            <li>
              <a href="new-server.php" class="text-2xl block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">New server</a>
            </li>
            <li>
    ...
    <div class="flex items-center justify-center h-screen space-x-40">
        <img class="boxindex rounded-md" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSb_LvyVYBYowhQc6TmelIj5pq9rXyBaaImnQ&usqp=CAU" alt="Serveurs de jeux">
        <img class="boxindex rounded-md" src="https://www.dz-techs.com/wp-content/uploads/2019/07/discord-bots-min-DzTechs.jpg" alt="Bots">  
        <img class="boxindex rounded-md" src="https://dwglogo.com/wp-content/uploads/2017/09/3630px-Nginx_logo.png" alt="Serveurs Web">  
      </div>
</body>
</html>